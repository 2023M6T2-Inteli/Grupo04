...
const Welcome = () => {
  return (
    <div className="grid h-screen pt-12 pb-3 grid-rows-4 grid-cols-none place-content-center col-span-2">
      <div className="relative flex border-white place-content-center">
        <Image
          src={gerdauLogoBlue}
      ...
      <div className="flex place-content-center justify-center content-center pb-5">
        <p className="font-inter text-lg pr-20 pl-20">
