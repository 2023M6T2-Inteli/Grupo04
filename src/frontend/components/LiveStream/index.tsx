  ...
  return (
    ...
    <div className="ml-auto mr-auto w-2/4 border-2 rounded-2xl relative">
      <div className="flex flex-col gap-5 rounded-2xl h-11/12 shadow-2xl">  
        <div className="text-gray-700 text-xl text-left font-bold text-left mt-2 ml-2">First Analyze</div>
        ...
        <div className="mx-6 my-4 flex flex-row">
            <div className="text-gray-700 text-lg basis-2/4 text-center"><b>Gas:</b> 100%</div>
            <div className="text-gray-700 text-lg basis-2/4 text-center"><b>Oxygen:</b> 100%</div>
          </div>
